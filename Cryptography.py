...
def main():
    sfname = './images/source_file.jpg'
    efname = './images/encrypted_file.jpg'
    tfname = './images/decrypted_file.jpg'

    user_key = 'Where is the smallest island?' #useer remark or user key inputs
